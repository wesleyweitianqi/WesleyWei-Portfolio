    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
          ...
          >
            Wesley &nbsp;<span className="sm:block hidden">| Wei</span>
          </p>
        </Link>
        <div className="flex flex-row gap-3">
          <div className="w-9 h-9 object-contain">
            <a href="https://github.com/wesleyweitianqi">
              <img src={github} alt="github" />
            </a>
          </div>
          <div className="w-9 h-9 object-contain">
            <a href="https://resume.creddle.io/resume/iy2js0o7wgf">
              <img src={resume} alt="ins" />
            </a>
          </div>
          <div className="w-9 h-9 object-contain">
            <a href="https://www.linkedin.com/in/wesleywei-tech/">
